...
<head>
    ...
    .impar { color: #1E90FF; font-weight: bold; }
    .par { color: #FF6600; font-weight: bold; }
...
<body class="bg-gray-100 min-h-screen flex flex-col items-center py-8">
    <div class="container mx-auto max-w-4xl bg-white shadow-lg rounded-lg p-6">
        ...
        <div class="mb-8">
            <h2 class="centrado">Ejercicio 2</h2>
            <p>Crear un programa para la generación repetitiva de 3 números aleatorios hasta obtener un secuencia compuesta por:</p>
            <?php secuenciaImparParImpar(); ?>
        </div>

        <div class="mb-8">
            <h2 class="centrado">Ejercicio 3</h2>
            <?php
        ...
        <div class="mb-8">
            <h2 class="centrado">Ejercicio 4</h2>
            <p>Crear un arreglo cuyos indices van de 97 a 122 y cuyos valores son las letras correspondientes del alfabeto.</p>
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 bg-gray-50 p-4 rounded-lg">
                <?php
        ...
        <div class="mb-8">
            <h2 class="centrado">Ejercicio 5</h2>
            ...
            <form action="http://localhost/tecweb/practicas/p06/index.php" method="post">
                <label for="edad">Edad: </label><input type="number" name="edad" required class="border rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-blue-500"><br>
                <label for="sexo">Sexo: </label>
                <select name="sexo" id="sexo" required class="border rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                    <option value="">Seleccione</option>
                    <option value="Femenino">Femenino</option>
                    <option value="Masculino">Masculino</option>
                </select><br><br>
                <input type="submit" value="Enviar" class="bg-green-500 text-white px-4 py-2 rounded-lg hover:bg-green-600">
            </form>
            <?php
        ...
        <div class="mb-8">
            <h2 class="centrado">Ejercicio 6</h2>
            ...
            <form action="http://localhost/tecweb/practicas/p06/index.php" method="post">
                ...
                <input type="text" name="matricula" id="matricula" placeholder="Ej. ABC1234" class="border border-gray-300 rounded px-2 py-1">
                <br><br>
                <button type="submit" name="buscar" class="bg-green-500 text-white px-4 py-2 rounded-lg hover:bg-green-600">Buscar</button>
                <button type="submit" name="mostrar_todos" class="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600">Mostrar Todos</button>
            </form>
            <?php
