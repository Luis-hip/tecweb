...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if($result->num_rows > 0) {
        ...
        echo '<a href="http://localhost/tecweb/practicas/p08/formulario_productos.html">Intentar nuevamente</a>';
    } else {
        ...
        if ($link->query($sql)) {
            ...
            echo '</ul>';
            echo '<a href="http://localhost/tecweb/practicas/p08/formulario_productos.html">Agregar otro producto</a>';
        } else {
